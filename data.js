...
/* ===================== 데이터 (3막 깊은 그래프) =====================
   중심 실: 고철 로봇이 자길 만들고 떠난 '그 사람'의 흐릿한 얼굴을 안고 걷는다.
   감정을 배울수록(person 노드) 그 얼굴이 또렷해지고(mem), 길 끝에서 재회 → 사람이 된다.
   person = 만남이자 업그레이드 생성기. lines[0]=첫 만남, 이후=재회 심화. mem=그 사람 기억 한 조각. */
const PEOPLE = {
...
const NODES = [
  ...
  { id:"cat_pos",     type:"category", parent:"start", cost:10, gen:0, icon:"🌤", name:"긍정·흥미",
    intro:"밝고 끌리는 마음들이\n이 갈래에 모여 있다." },
  { id:"cat_unease",  type:"category", parent:"start", cost:30, gen:0, icon:"🌫", name:"불안·불편",
    intro:"피하고 싶은데\n알아둬야 하는 마음들." },
  { id:"cat_intense", type:"category", parent:"start", cost:80, gen:0, icon:"🔥", name:"강한 자극",
    intro:"확 타오르는\n뜨거운 마음들." },
  { id:"cat_calm",    type:"category", parent:"start", cost:50, gen:0, icon:"🌊", name:"잔잔·시림",
    intro:"고요하고\n시린 마음들." },
  // ▸ 긍정·흥미 (10) — 밝고 끌리는
  ...
  { id:"amuse",   type:"person", key:"amuse",   parent:"cat_pos", cost:20,  gen:0.70, icon:"❀" },
  { id:"flutter", type:"person", key:"flutter", parent:"cat_pos", cost:24,  gen:0.80, icon:"❀" },
  { id:"curious", type:"person", key:"curious", parent:"cat_pos", cost:30,  gen:0.55, icon:"❀" },
  { id:"beauty",  type:"person", key:"beauty",  parent:"cat_pos", cost:40,  gen:0.75, icon:"❀" },
  { id:"admire",  type:"person", key:"admire",  parent:"cat_pos", cost:46,  gen:0.70, icon:"❀" },
  { id:"awe",     type:"person", key:"awe",     parent:"cat_pos", cost:70,  gen:1.10, icon:"❀" },
  { id:"trance",  type:"person", key:"trance",  parent:"cat_pos", cost:80,  gen:1.15, icon:"❀" },
  { id:"satisfy", type:"person", key:"satisfy", parent:"cat_pos", cost:90,  gen:1.70, icon:"❀" },
  // ▸ 불안·불편 (7)
  { id:"fear",    type:"person", key:"fear",    parent:"cat_unease", cost:18,  gen:0.50, icon:"❀" },
  { id:"confuse", type:"person", key:"confuse", parent:"cat_unease", cost:24,  gen:0.60, icon:"❀" },
  { id:"bored",   type:"person", key:"bored",   parent:"cat_unease", cost:30,  gen:1.40, icon:"❀" },
  { id:"awkward", type:"person", key:"awkward", parent:"cat_unease", cost:36,  gen:1.00, icon:"❀" },
  { id:"anxiety", type:"person", key:"anxiety", parent:"cat_unease", cost:46,  gen:0.95, icon:"❀" },
  { id:"disgust", type:"person", key:"disgust", parent:"cat_unease", cost:55,  gen:1.05, icon:"❀" },
  { id:"horror",  type:"person", key:"horror",  parent:"cat_unease", cost:120, gen:1.90, icon:"❀" },
  // ▸ 강한 자극 (5) — 확 타오르는
  { id:"excite",  type:"person", key:"excite",  parent:"cat_intense", cost:26,  gen:0.75, icon:"❀" },
  { id:"relief",  type:"person", key:"relief",  parent:"cat_intense", cost:40,  gen:1.60, icon:"❀" },
  { id:"attract", type:"person", key:"attract", parent:"cat_intense", cost:66,  gen:1.60, icon:"❀" },
  { id:"crave",   type:"person", key:"crave",   parent:"cat_intense", cost:130, gen:1.70, icon:"❀" },
  { id:"triumph", type:"person", key:"triumph", parent:"cat_intense", cost:140, gen:1.80, icon:"❀" },
  // ▸ 잔잔·시림 (5) — 고요하고 시린
  { id:"sorrow",  type:"person", key:"sorrow",  parent:"cat_calm", cost:16,  gen:0.45, icon:"❀" },
  { id:"empathy", type:"person", key:"empathy", parent:"cat_calm", cost:34,  gen:0.80, icon:"❀" },
  { id:"longing", type:"person", key:"longing", parent:"cat_calm", cost:44,  gen:0.85, icon:"❀" },
  { id:"compassion",type:"person",key:"compassion",parent:"cat_calm",cost:52, gen:0.90, icon:"❀" },
  { id:"calm",    type:"person", key:"calm",    parent:"cat_calm", cost:64,  gen:1.30, icon:"❀" },
